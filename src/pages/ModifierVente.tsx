    ...
    <Card className="grid w-[700px] my-8">
      ...
      <CardContent className="grid grid-cols-2 gap-8">
        ...
        <div className="flex flex-col space-y-4">
            ...
            <div>
            <Label className='text-title-blue' htmlFor="framework">Modifiez la date de vente</Label>
        ...
        <div className="flex flex-col space-y-4">
            ...
            <div>
            <Label className='text-title-blue' htmlFor="additionalInput">Modifiez la quantité vendue</Label>
            <Input id="additionalInput" placeholder="Quantité" />
            </div>
            <div>
            <Label className='text-title-blue' htmlFor="additionalInput">Modifiez le client</Label>
